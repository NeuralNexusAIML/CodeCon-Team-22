...
<!-- Contact Us Section -->
<section id="contact" class="bg-white py-8">
    <div class="container mx-auto flex flex-col items-center">
        <h2 class="text-2xl mb-4">Contact Us</h2>
        <form class="w-full max-w-lg" method="POST" action="contactform.php">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id="message" name="message" placeholder="Enter your message here" rows="6"></textarea>
                </div>
            </div>
